...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 11.56; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -4.60; // in; offset of the lateral wheel
